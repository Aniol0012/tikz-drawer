...
export const EDITOR_THEME_TOGGLE_COOLDOWN_MS = 420;
...
export const LINE_DASHED_PATTERN = [6, 4] as const;
export const LINE_DOTTED_PATTERN = [0.8, 3.2] as const;
export const LINE_DASH_DOTTED_PATTERN = [6, 3, 0.8, 3] as const;
export const LINE_LOOSELY_DASHED_PATTERN = [10, 6] as const;
...
export const FREEHAND_SIMPLIFICATION_TOLERANCE = 0.09;
...
export const EDITOR_RIGHT_SIDEBAR_MOBILE_MIN_HEIGHT = 150;
...
export const EDITOR_OBJECT_SNAP_TOLERANCE_PX = 10;
...
export const EDITOR_CONTEXT_MENU_SCROLL_DISMISS_THRESHOLD_PX = 160;
...
export const EDITOR_DRAG_AUTO_PAN_EDGE_PX = 72;
