...
const iconPaths = {
  ...
  code: 'M8.7 16.7 3.9 12l4.8-4.7 1.4 1.4L6.7 12l3.4 3.3-1.4 1.4Zm6.6 0-1.4-1.4 3.4-3.3-3.4-3.3 1.4-1.4 4.8 4.7-4.8 4.7Z',
  settings:
...
export class EditorPageComponent {
  ...
  readonly dockTools: readonly {
    readonly panel: Exclude<DockPanel, null>;
    readonly label: string;
    readonly iconPath: string;
  }[] = [
